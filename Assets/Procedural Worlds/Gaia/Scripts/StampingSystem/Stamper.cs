...
namespace Gaia
{
    ...
    public class Stamper : MonoBehaviour
    {
        ...
        public List<Terrain> m_lastAffectedTerrains = new List<Terrain>();
...
#pragma warning restore 414
        ...
        public void Stamp(List<string> validTerrainNames = null, List<StamperSettings> worldMapStamperSettings = null)
        {
        ...
        /// </summary>
        /// <param name="stamperSettings">The stamper settings to store the updated results in.</param>
        /// <param name="injectValues">Allows to set a custom fixed min max height instead of actually measuring the terrains</param>
        /// <param name="injectMin">The minimum to inject</param>
        /// <param name="injectMax">The maximum to inject</param>
        ...
        public void DrawStampPreview(List<StamperSettings> worldMapStamperSettings = null, bool isWorldMapPreview = false)
        {
            if (!m_drawPreview)
            {
                return;
        ...
        public RenderTexture ApplyBrush(GaiaMultiTerrainOperation operation, List<StamperSettings> worldMapStamperSettings = null, bool isWorldMapPreview = false)
        {
        ...
        /// </summary>
        /// <param name="operation">The operation to render the texture for.</param>
        /// <param name="settings">The stamper settings to render the texture for, usually the current settings of the stamper, but other settings can be passed in as well</param>
        /// <param name="concatenateMode">If this flag is active, the stamper will use the cached render texture of a previous run instead of the current terrain heightmap. This allows to "concatenate" multiple stamper operations together.</param>
        /// <returns></returns>
