...
namespace Gaia
{
    ...
    public class GaiaResource
    {
        ...
        public ResourceProtoStamp[] m_stampDistributionPrototypes = new ResourceProtoStamp[0];
        ...
        [Tooltip("Prototypes for Terrain Modifier Stampers")]
        public ResourceProtoTerrainModifierStamp[] m_terrainModifierStampPrototypes = new ResourceProtoTerrainModifierStamp[0];
        ...
        public int PrototypeIdxInTerrain(GaiaConstants.SpawnerResourceType resourceType, int resourceIdx, Terrain terrain = null)
        {
            ...
            switch (resourceType)
            {
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    ...
                    foreach (TerrainLayer proto in terrain.terrainData.terrainLayers)
                    {
                        ...
                        if (splat != null && proto != null)
                        {
                            ...
                            {
                                if (PWCommon5.Utils.IsSameTexture(splat.m_texture, proto.diffuseTexture, false) == true)
                                {
                                    return localTerrainIdx;
                                }
                            }
                ...
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    ...
                    foreach (DetailPrototype proto in terrain.terrainData.detailPrototypes)
                    {
...
#endif
                        {
                            ...
                            if (PWCommon5.Utils.IsSameGameObject(detail.m_detailProtoype, proto.prototype, false))
                            {
                                return localTerrainIdx;
                            }
                ...
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    ...
                    {
                        if (PWCommon5.Utils.IsSameGameObject(tree.m_desktopPrefab, proto.prefab, false))
                        {
                            return localTerrainIdx;
                        }
                        localTerrainIdx++;
        ...
        public void AddMissingPrototypesToTerrain(Terrain terrain)
        {
            ...
            foreach (ResourceProtoTexture splat in m_texturePrototypes)
            {
                ...
                {
                    if (PWCommon5.Utils.IsSameTexture(sp.texture, splat.m_texture, false))
                    {
                        found = true;
                    }
                }
            ...
            foreach (ResourceProtoDetail detail in m_detailPrototypes)
            {
                ...
                foreach (DetailPrototype dp in terrainDetails)
                {
                    ...
                    {
                        if (PWCommon5.Utils.IsSameTexture(dp.prototypeTexture, detail.m_detailTexture, false))
                        {
                            found = true;
                        }
                        if (PWCommon5.Utils.IsSameGameObject(dp.prototype, detail.m_detailProtoype, false))
                        {
                            found = true;
                        }
            ...
            foreach (ResourceProtoTree tree in m_treePrototypes)
            {
                ...
                {
                    if (PWCommon5.Utils.IsSameGameObject(tp.prefab, tree.m_desktopPrefab, false))
                    {
                        found = true;
                    }
                }
