...
namespace Gaia.Pipeline.HDRP
{
    public static class GaiaHDRPRuntimeUtils
    {
        ...
        {
            TerrainHelper.SetTerrainMaterial(profile.m_highDefinitionTerrainMaterial, "Setup Default HDRP Terrain Shader?", "Do you want to set up the default Unity HDRP terrain shader on your existing terrains? This is recommended if you do not use any alternative terrain shader.", "Yes", "No");
        }
