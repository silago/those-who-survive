...
namespace Gaia.Pipeline.URP
{
    public static class GaiaURPRuntimeUtils
    {
        ...
        {
            TerrainHelper.SetTerrainMaterial(profile.m_universalTerrainMaterial, "Setup Default URP Terrain Shader?", "Do you want to set up the default Unity URP terrain shader on your existing terrains? This is recommended if you do not use any alternative terrain shader.", "Yes", "No");
        }
