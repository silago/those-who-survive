...
#if HDPipeline
            if (m_planarReflectionsHDRP != null)
            {
                m_planarReflectionsHDRP.SetReflectionState(state);
            }
            else
            {
                m_planarReflectionsHDRP = GameObject.FindObjectOfType<GaiaPlanarReflectionsHDRP>();
                if (m_planarReflectionsHDRP != null)
                {
                    m_planarReflectionsHDRP.SetReflectionState(state);
                }
